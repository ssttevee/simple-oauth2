...
export default class SimpleOAuth2<ClientIdName extends string = 'client_id'> {
    constructor(options: ModuleOptions<ClientIdName>);
    authorizationCode(): AuthorizationCodeClient<ClientIdName>;
    ownerPassword(): OwnerPasswordClient;
...
export interface AuthorizationCodeClient<ClientIdName extends string = 'client_id'> {
    /**
...
export interface OwnerPasswordClient {
    /** Returns the Access Token Object */
